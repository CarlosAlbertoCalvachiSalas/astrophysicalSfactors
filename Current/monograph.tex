...
\subsection{Results} \label{sub:resultsNonResonant}

\graph{Dp}{Dp reaction }{Detailed Caption reaction}

\graph{Dd}{Dd reaction}{Detailed caption reaction}

\graph{2H(d,p)3H}{D deuterium capture}{Detailed caption reaction}

\graph{2H(p,gamma)3He}{D proton radiative capture }{Detailed caption reaction}


\subsection{Analysis}  \label{sub:analysisNonResonant}
...
\subsection{Results} \label{sub:resultsResonant}

\graph{7Be(p,gamma)8B}{7Be radiative capture}{Detailed 7Be radiative capture}
\graph{13C(p,gamma)14N}{13C radiative capture}{Detailed 13C radiative capture}
\graph{C12C12}{C12 + C12 reaction}{Detailed 12C + 12C reaction}


\subsection{Analysis} \label{sub:analysisResonant}
